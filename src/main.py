...
from modules import DMSDRModel
...
if __name__ == '__main__':
    ...
    medicine131 = dill.load(open(medicine131_path, 'rb'))
    medicine1311 = medicine131
    # for i in range(131):
    #     for j in range(131):
    #         medicine1311[i][j] += 1
    #
    ...
    average_projection = average_projection.to(device)#131*283
    ...
    model = DMSDRModel(
        ...
        ehr_adj=ehr_adj, ddi_adj=ddi_adj,medicine131=medicine131
    ).to(device)
